...
using WebUsuarios.UI.And.WebApi.Models;
using WebUsuarios.UI.And.WebApi.Providers;
using WebUsuarios.UI.And.WebApi.Results;

namespace WebUsuarios.UI.And.WebApi.Controllers
{
    [Authorize]
